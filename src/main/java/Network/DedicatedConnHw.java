 ...
 */
public class DedicatedConnHw extends Thread {
     ...
     */
    public DedicatedConnHw(Socket socket, Vector<DedicatedConnHw> dedicatedConnections, Node ourNode, NetworkCallback nodeCallback) {
        try{
            this.socket = socket;
     ...
     * Constructor #2
     */
    public DedicatedConnHw(Node ourNode, Vector<DedicatedConnHw> dedicatedConnections, Node infoConnectedNode, NetworkCallback nodeCallback)  {
        this.ourNode = ourNode;
